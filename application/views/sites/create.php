        ...
        <div class="container">
          ...
          <div class="primary-controls pull-right">
                ...
                <span class="tooltip-item">
                      ...
                      <span class="tooltip-content clearfix">
                        <span class="tooltip-text">
                           <p class="tooltip__header">What you may do:</p>
                  ...
                  <span class="tooltip-item">
                      ...
                      <span class="tooltip-content clearfix">
                        <span class="tooltip-text">
                           <p class="tooltip__header">What you may do:</p>
                           <ul class="tooltip__list">
                             <li>- edit text color and size, even change font-family among predefined set;</li>
                             <li>- choose different icons among FontAwesome set;</li>
        	...
        	<div class="screen" id="screen">
                ...
                <span><span class="highlight">Build your page</span> by dragging elements onto the canvas</span>
              </div>
        		</div>
