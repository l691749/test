	    ...
	    <div class="container-fluid">
	    	...
	    	<div class="row">
	    		...
	    		<div class="col-sm-12">
			    	...
			    	<h1 class="page-name"><?php echo $this->lang->line('settings_heading')?></h1>
					...
					<div class="tab-content">
						...
						<div class="tab-pane active" id="appSettings">
							...
							<div class="row">
								...
								<div class="col-md-8 col-lg-6 form-panel">
									...
									<form class="form-horizontal settingsForm" role="form" id="settingsForm" method="post" action="<?php echo site_url('configuration/update')?>">
										...
										<div class="form-group">
											...
											<div class="col-sm-9 additional-space">
								...
								<div class="col-md-4 col-lg-6 configHelpContainer">
